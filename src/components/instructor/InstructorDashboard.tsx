...
export const InstructorDashboard: React.FC<Props> = ({ onSelectClass, onNavigate, onOpenTutorial }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-10 py-4 px-2 sm:px-0">
      ...
      <header data-tour="instructor-dashboard-header" className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-4 pb-6 border-b border-slate-200">
        <div>
      ...
      <section data-tour="instructor-summary-stats" className="flex flex-wrap items-baseline gap-8 sm:gap-12 py-2 text-sm text-slate-600">
      ...
      <section data-tour="instructor-priority-class" className="space-y-3 pt-2">
      ...
      <section data-tour="instructor-other-classes" className="space-y-3 pt-2">
        <div className="flex items-center justify-between">
          <span className="text-[11px] font-semibold uppercase tracking-wider text-slate-500">
            Các lớp khác
          </span>
      ...
      <section data-tour="instructor-recent-activity" className="space-y-3 pt-4 border-t border-slate-200">
        <div className="flex items-center justify-between">
          <span className="text-[11px] font-semibold uppercase tracking-wider text-slate-500">
            Hoạt động gần đây
          </span>
